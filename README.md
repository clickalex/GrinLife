...
npm run audit      # 122 checks over the repo, the build, the live server and the content model
npm run audit:md   # the same 122 checks, written to AUDIT.md
...
`npm run audit` runs 122 numbered checks and prints what each one observed:
