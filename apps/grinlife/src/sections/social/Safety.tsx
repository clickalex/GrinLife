    ...
    <Section sectionId="safety">
      <div className="space-y-8">
        <div className="space-y-3">
          ...
          <Lede>
            The moment strangers can message each other, the product changes character. These are not promises
            — they are obligations that must be live at launch.
          </Lede>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <Card accent="moss" variant="paper" className="p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-ink-soft">
              ...
              server-side log exists solely for safety and legal response, and its retention is stated plainly
              in the privacy policy. "No logs at all" would mean no evidence, no actionable reports and no
              cooperation with a court order — which is exactly the fact pattern regulators call negligent
              design.
            </p>
          </Card>
        ...
        <Callout tone="warning" label="This is not a dating app">
          <p>
            ...
            explicit community standards, and fast enforcement on unwanted romantic advances. If that is what
            you are looking for, this is the wrong product.
          </p>
        </Callout>

        <p className="text-xs text-muted-foreground">Sources: {social.sources.join(" · ")}</p>
      </div>
    </Section>
  );
}
